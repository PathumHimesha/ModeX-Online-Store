...
<body>
    ...
    <div class="container mb-5">
        <% if (cart_list != null && cartProduct != null && !cartProduct.isEmpty()) { %>
            ...
            <h2 class="mt-5 mb-0 animate__animated animate__fadeInLeft">YOUR BAG</h2>
            <p class="text-muted small animate__animated animate__fadeInLeft"><%= cart_list.size() %> Items ready for checkout</p>
